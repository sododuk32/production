...
import Debouncer from '../lib/commonFnc/Deboncer';
...
const Home = () => {
	...
	const handleWheel2 = Debouncer((event: WheelEvent) => {
		// 애니메이션 삽입 코드
		if (event.deltaY < 0) {
			// scroll up
	...
	return (
		<div>
			<Head>
				...
				/>
				<meta name='description' content='teaon Developer Construction' />
						...
						<section className={style.slideSection}>
							...
							>
								<div
									...
									id={style.nextbtn}
								>
									<ArrowNext width={4} height={4} />
								</div>
								<div
									className='swiper-button-prev'
									style={{ ...arrowStyleM, left: '-2vw', top: '45%' }}
									id={style.nextbtn}
								>
									<ArrowPrev width={4} height={4} />
								</div>
								<SwiperSlide
								...
								{isTablet || isMobile ? (
									...
									<div className={style.footerWarn}>
										<span>
											...
											이해를 돕기 위해 제작된 것으로 실제와 다를 수
											있으며,&nbsp;
										</span>

										<span>
											인·허가 과정 및 시행사, 시공사 사정 등 기타 제반 사유에
											의하여 변경 될 수 있으니 계약전 반드시 확인하시기
											바랍니다.
										</span>
									</div>
								)}
